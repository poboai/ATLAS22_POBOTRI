...
docker volume create atlas22_pobotri-output-$VOLUME_SUFFIX
...
docker run --rm \
        ...
        -v atlas22_pobotri-output-$VOLUME_SUFFIX:/output/ \
        atlas22_pobotri
...
docker volume rm atlas22_pobotri-output-$VOLUME_SUFFIX
